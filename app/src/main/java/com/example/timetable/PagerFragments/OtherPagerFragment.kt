...
import com.example.timetable.databinding.FragmentOtherPagerBinding

class OtherPagerFragment : Fragment() {
    lateinit var binding: FragmentOtherPagerBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOtherPagerBinding.inflate(layoutInflater)
